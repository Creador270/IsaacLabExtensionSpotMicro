...
def some_public_function(x: int):
    print("[IsaacLabExtensionSpotMicro] some_public_function was called with x: ", x)
    return x**x
...
class ExampleExtension(omni.ext.IExt):
    ...
    def on_startup(self, ext_id):
        print("[IsaacLabExtensionSpotMicro] startup")
    ...
    def on_shutdown(self):
        print("[IsaacLabExtensionSpotMicro] shutdown")