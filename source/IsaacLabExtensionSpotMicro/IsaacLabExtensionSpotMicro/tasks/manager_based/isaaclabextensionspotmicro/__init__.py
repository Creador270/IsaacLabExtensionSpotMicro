...
gym.register(
    id="Template-Isaaclabextensionspotmicro-Rough-1.0",
...
gym.register(
    id="Template-Isaaclabextensionspotmicro-Rough-Play-1.0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
...
gym.register(
    id="Template-Isaaclabextensionspotmicro-Flat-1.0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
...
gym.register(
    id="Template-Isaaclabextensionspotmicro-Flat-Play-1.0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
